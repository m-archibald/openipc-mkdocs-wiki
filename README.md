...
A modern, well-organized documentation site for the OpenIPC project, built with MkDocs and Material theme.

## 🚀 Features

- **Modern Design**: Built with MkDocs Material theme for excellent user experience
- **Multi-Language Support**: English and Russian content
- **Responsive Layout**: Works perfectly on desktop, tablet, and mobile
- **Fast Search**: Powerful search functionality across all documentation
...
│   │   ├── usage/          # Usage and configuration
│   │   ├── fpv/            # FPV-specific content
│   │   ├── troubleshooting/ # Troubleshooting guides
│   │   ├── equipment/       # Hardware equipment info
│   │   ├── development/     # Development documentation
│   │   ├── help/           # Help and tips
│   │   ├── hardware/        # Hardware information
│   │   ├── cameras/        # Camera-specific guides
...
```bash
git clone https://github.com/yourusername/openipc-mkdocs-wiki.git
cd openipc-mkdocs-wiki
```
...
### Introduction
- About OpenIPC project
- Supported devices and sensors
- Changelog

### Installation
- General installation guide
- Platform-specific instructions (Goke, HiSilicon, Ingenic, etc.)
- Legacy documentation

### Usage
- Network configuration
- Majestic streamer setup
- System features
...
We welcome contributions! Please see our [Contributing Guide](docs/en/reference/contribute.md) for details.
...
This project maintains the same license as the original OpenIPC wiki.

## 🙏 Acknowledgments

- Based on the original [OpenIPC Wiki](https://github.com/OpenIPC/wiki)
- Built with [MkDocs](https://www.mkdocs.org/)
- Theme by [MkDocs Material](https://squidfunk.github.io/mkdocs-material/)

## 🔗 Links

- **Original Project**: [OpenIPC](https://openipc.org/)
- **GitHub**: [OpenIPC Organization](https://github.com/OpenIPC/)
- **Telegram**: [OpenIPC Community](https://openipc.org/our-channels)
- **Live Site**: [OpenIPC MkDocs Wiki](https://yourusername.github.io/openipc-mkdocs-wiki/)
...
- [Ростелеком IPC-HDW1230SP v3](ru/rostelecom-ipc-hdw1230sp_v3.md)
